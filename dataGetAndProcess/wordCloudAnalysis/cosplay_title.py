...
if __name__ == '__main__':
    with open("../data/preData/preCos.json", encoding="utf-8") as file:
    ...
    img = Image.open(r'.\src\蒙版4.png')   #打开遮罩图片
    img_array = np.array(img)   #将图片转换为数组
    # 停词表生成
    stopwords = getStopWords(r'src\stop_words.txt')
    stopwords += ["港澳台", "地区", "第二季", "地區", "OVA", "台灣", "僅限", "剧场版", "第一季", "第三季", "篇", "cosplay"]
    wc = WordCloud(
    ...
    #输出词云图片到文件
    wc.to_file("../image/cos_title.png")